...
const Logo = ({color = 'white', size = 'md', hideText = false }: LogoProps) => (
	<S.Wrapper color={color} size={size} hideText={hideText}>
		<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 158 48" role="img" aria-label="Won Games">
			...
			/>
			<defs><linearGradient id="a" x1="29.159" x2="30.155" y1="-7.397" y2="49.103" gradientUnits="userSpaceOnUse"><stop stopColor="#FF5F5F"/><stop offset="1" stopColor="#F062C0"/><stop offset="1" stopColor="#F23131"/></linearGradient></defs></svg>
	</S.Wrapper>
)
